...
export type ProjectChangeListener = (entry: ProjectLogEntry) => void;
...
class ProjectLogStore {
  ...
  addListener(listener: ProjectChangeListener): () => void {
...
export function addProjectLogListener(listener: ProjectChangeListener): () => void {
