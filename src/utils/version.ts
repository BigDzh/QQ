...
const VERSION_HISTORY = [
  { version: 'v3.1.0', date: '2026-05-10', changes: 'v3.0.0大版本完成：主题系统7种主题完善、性能监控96个组件使用、告警系统完善、测试通过率100%(278/278)、E2E测试63个、构建通过(6.05s)；v3.1.0小版本迭代开始' },
  { version: 'v3.0.0', date: '2026-04-08', changes: '主题系统7种主题(dark/cyberpunk/linear/anime/cosmos/classical/minimal)、性能监控系统完善、告警系统完善、测试体系100%单元测试通过+63个E2E测试、100%测试通过率(278/278)' },
  { version: 'v2.33.0', date: '2026-04-08', changes: 'E2E测试从9个增加到63个：创建e2e/management.spec.ts(15个)、e2e/workflows.spec.ts(13个)、e2e/details.spec.ts(11个)测试用例' },
