...
export default function WorkflowDetail() {
  ...
  const [_editingStep, _setEditingStep] = useState<Step | null>(null);
  const [_showStepEditModal, _setShowStepEditModal] = useState(false);
  ...
  const handleUpdateStep = (updatedStep: Step) => {
    ...
    updateWorkflow({ steps: updatedSteps });
    _setShowStepEditModal(false);
    _setEditingStep(null);
                              ...
                              onChange={(e) => {
                                const updated = {
                                  ...
                                  execution: { 
                                    ...
                                    retryCount: step.execution?.retryCount || 0,
                                    resourceTags: step.execution?.resourceTags || [],
                                  }
                                };
                                handleUpdateStep(updated);
                              }}
                            ...
                            <input
                              ...
                              onChange={(e) => {
                                const updated = {
                                  ...step,
                                  execution: {
                                    priority: step.execution?.priority || 5,
                                    timeout: parseInt(e.target.value) || 0,
                                    retryCount: step.execution?.retryCount || 0,
                                    assignedTo: step.execution?.assignedTo,
                                    resourceTags: step.execution?.resourceTags || [],
                                  }
                                };
                                handleUpdateStep(updated);
