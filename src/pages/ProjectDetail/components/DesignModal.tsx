...
import type { ProjectStage, ProjectVersion, DesignFile, Module, Component } from '../../../types';
...
interface DesignModalProps {
  ...
  form: DesignFormData;
  onChange: (field: keyof DesignFormData, value: string | string[] | boolean) => void;
  editingDesignFile: DesignFile;
  modules: Module[];
  components: Component[];
}

export function DesignModal({ show, onClose, onSubmit, form, onChange, editingDesignFile, modules, components: _components }: DesignModalProps) {
