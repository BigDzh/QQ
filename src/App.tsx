              ...
              <MemoryMonitorWrapper>
                <Layout>
                  ...
                  <Routes>
                    ...
                    <Route path="/projects/:id" element={<RetryableLazy loader={() => import('./pages/ProjectDetail')} fallback={<PageLoader />} maxRetries={3} retryDelay={1000} />} />
